...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   SSL_Indicator.Pair = Pair;
   SSL_Indicator.Timeframe = Timeframe;
   SSL_Indicator.SSL_Method = ssl_ma_method;
   SSL_Indicator.SSL_Length = ssl_period;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return SSL_Indicator.CheckSignal(1);
}
//+------------------------------------------------------------------+
