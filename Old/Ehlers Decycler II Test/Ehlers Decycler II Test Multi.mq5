#include "Ehlers Decycler II Test Class.mqh"
...
input group "Ehlers Decycler II Inputs:"
input int input_decycler_period = 20; // Period
input double input_channel_width = 0.2; // Channel Width
//+------------------------------------------------------------------+
//| Globals:                                                         |
//+------------------------------------------------------------------+
