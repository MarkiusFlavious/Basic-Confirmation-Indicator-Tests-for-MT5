...
//| Includes:                                                        |
//+------------------------------------------------------------------+
#include "Squeeze Test Class.mqh"
//+------------------------------------------------------------------+
//| Inputs:                                                          |
//+------------------------------------------------------------------+
...
input int input_squeeze_period = 20; // Period
input double input_dev_multiplier = 1; // Deviation multiplier
input double input_atr_multiplier = 1; // ATR multiplier
//+------------------------------------------------------------------+
//|Global:                                                           |
//+------------------------------------------------------------------+
CSingleIndicatorTester Simple_Strategy(_Symbol,
                                       ...
                                       input_move_stop,
                                       input_trail_stop,
                                       input_squeeze_period,
                                       input_dev_multiplier,
                                       input_atr_multiplier);
//+------------------------------------------------------------------+
