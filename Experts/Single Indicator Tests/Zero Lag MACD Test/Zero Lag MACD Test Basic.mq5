...
//| Includes:                                                        |
//+------------------------------------------------------------------+
#include "Zero Lag MACD Test Class.mqh"
//+------------------------------------------------------------------+
//| Inputs:                                                          |
//+------------------------------------------------------------------+
...
input uint input_fast_period = 12; // Fast Period
input uint input_slow_period = 26; // Slow Period
input uint input_signal_period = 9; // Signal Period
input ENUM_APPLIED_PRICE input_zl_macd_app_price = PRICE_CLOSE; // Applied Price
//+------------------------------------------------------------------+
//|Global:                                                           |
//+------------------------------------------------------------------+
