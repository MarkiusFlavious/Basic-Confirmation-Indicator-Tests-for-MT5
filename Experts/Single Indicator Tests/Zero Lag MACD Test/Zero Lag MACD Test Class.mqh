...
#include <Custom/Confirmation Indicators/Zero Lag MACD.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_ZeroLagMACD.Pair = pair;
   C1_ZeroLagMACD.Timeframe = timeframe;
   C1_ZeroLagMACD.ZL_MACD_Fast_Period = zl_macd_fast_period;
   C1_ZeroLagMACD.ZL_MACD_Slow_Period = zl_macd_slow_period;
   C1_ZeroLagMACD.ZL_MACD_Signal_Period = zl_macd_signal_period;
   C1_ZeroLagMACD.ZL_MACD_App_Price = zl_macd_app_price;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_ZeroLagMACD.CheckSignal(1);
}
//+------------------------------------------------------------------+
