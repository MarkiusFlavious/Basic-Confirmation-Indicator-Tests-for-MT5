...
#include <Custom/Confirmation Indicators/Reflex.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_Reflex.Pair = pair;
   C1_Reflex.Timeframe = timeframe;
   C1_Reflex.Reflex_Period = reflex_period;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_Reflex.CheckSignal(1);
}
//+------------------------------------------------------------------+
