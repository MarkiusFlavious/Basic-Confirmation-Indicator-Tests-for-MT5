#include "Supertrend Test Class.mqh"
...
input group "Supertrend Inputs:"
input bool input_trail_with_st = false; // Use Supertrend Hull for trail stop
input int input_super_period = 10; // Supertrend Period
input double input_super_multiplier = 3; // Supertrend Multiplier
//+------------------------------------------------------------------+
//| Globals:                                                         |
//+------------------------------------------------------------------+
