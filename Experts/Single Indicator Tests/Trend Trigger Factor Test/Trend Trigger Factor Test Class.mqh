...
#include <Custom/Confirmation Indicators/Trend Trigger Factor.mqh>
//+------------------------------------------------------------------+
...
// Input Parameters:
   ...
   // Indicator:
   TrendTriggerFactor C1_TrendTriggerFactor;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_TrendTriggerFactor.Pair = pair;
   C1_TrendTriggerFactor.Timeframe = timeframe;
   C1_TrendTriggerFactor.TTF_Period = ttf_period;
   C1_TrendTriggerFactor.TTF_T3_Period = ttf_t3_period;
   C1_TrendTriggerFactor.TTF_T3_Hot = ttf_t3_hot;
   C1_TrendTriggerFactor.TTF_T3_Type = ttf_t3_type;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_TrendTriggerFactor.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_TrendTriggerFactor.CheckSignal(1);
}
//+------------------------------------------------------------------+
