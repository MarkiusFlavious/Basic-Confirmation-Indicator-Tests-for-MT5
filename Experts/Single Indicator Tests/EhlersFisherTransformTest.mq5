...
input group "Ehlers Fisher Transform Input"
input int inpLength = 10; // Length
//+------------------------------------------------------------------+
//| Handles                                                          |
//+------------------------------------------------------------------+
int ATRChannelHandle;
int EhlersFisherTransformHandle;
//+------------------------------------------------------------------+
//| Global Variables                                                 |
//+------------------------------------------------------------------+
int barTotal;
...
int OnInit()
  {
   ...
   EhlersFisherTransformHandle = iCustom(_Symbol,Timeframe,"EhlersFisherTransformIndicator.ex5",inpLength);
...
enTradeSignal CheckForSignal()
  {
   // Colour Buffer at 1. 1 is Red, 2 is Green.
   double ColourValues[];
   CopyBuffer(EhlersFisherTransformHandle,1,1,2,ColourValues);
