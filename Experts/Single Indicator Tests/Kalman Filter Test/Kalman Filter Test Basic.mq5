...
//| Includes:                                                        |
//+------------------------------------------------------------------+
#include "Kalman Filter Test Class.mqh"
//+------------------------------------------------------------------+
//| Inputs:                                                          |
//+------------------------------------------------------------------+
...
input KALMAN_TIMEFRAMES input_kf_timeframe = TF_CU; // Timeframe
input double input_kf_period = 1; // Period/smoothing ratio
input ENUM_APPLIED_PRICE input_kf_app_price = PRICE_CLOSE; // Price
input KALMAN_INTERPOLATE input_kf_interpolate = INTERPOLATE_YES; // Interpolation
//+------------------------------------------------------------------+
//|Global:                                                           |
//+------------------------------------------------------------------+
