...
#include <Custom/Confirmation Indicators/Kalman Filter.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_KalmanFilter.Pair = pair;
   C1_KalmanFilter.Timeframe = timeframe;
   C1_KalmanFilter.KF_Timeframe = kf_timeframe;
   C1_KalmanFilter.KF_Period = kf_period;
   C1_KalmanFilter.KF_App_Price = kf_app_price;
   C1_KalmanFilter.KF_Interpolate = kf_interpolate;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_KalmanFilter.CheckSignal(1);
}
//+------------------------------------------------------------------+
