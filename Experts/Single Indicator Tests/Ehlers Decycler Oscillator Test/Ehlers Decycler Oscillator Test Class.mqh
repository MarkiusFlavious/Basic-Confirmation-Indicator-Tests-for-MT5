...
// Input Parameters:
   ...
   // Indicator:
   EhlersDecyclerOscillator C1_EhlersDecyclerOscillator;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_EhlersDecyclerOscillator.Pair = pair;
   C1_EhlersDecyclerOscillator.Timeframe = timeframe;
   C1_EhlersDecyclerOscillator.Decycler_Period1 = decycler_period1;
   C1_EhlersDecyclerOscillator.Decycler_Period2 = decycler_period2;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_EhlersDecyclerOscillator.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_EhlersDecyclerOscillator.CheckSignal(1);
}
//+------------------------------------------------------------------+
