...
#include <Custom/Confirmation Indicators/T3 Floating Levels.mqh>
//+------------------------------------------------------------------+
...
// Input Parameters:
   ...
   // Indicator:
   T3FloatingLevels C1_T3FloatingLevels;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_T3FloatingLevels.Pair = pair;
   C1_T3FloatingLevels.Timeframe = timeframe;
   C1_T3FloatingLevels.T3_Period = t3_period;
   C1_T3FloatingLevels.T3_Volume_Factor = t3_volume_factor;
   C1_T3FloatingLevels.T3_Calc_Mode = t3_calc_mode;
   C1_T3FloatingLevels.T3_App_Price = t3_app_price;
   C1_T3FloatingLevels.T3_Color_Chg = t3_color_chg;
   C1_T3FloatingLevels.T3_Floating_Period = t3_floating_period;
   C1_T3FloatingLevels.T3_Floating_Upper = t3_floating_upper;
   C1_T3FloatingLevels.T3_Floating_Lower = t3_floating_lower;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_T3FloatingLevels.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_T3FloatingLevels.CheckSignal(1);
}
//+------------------------------------------------------------------+
