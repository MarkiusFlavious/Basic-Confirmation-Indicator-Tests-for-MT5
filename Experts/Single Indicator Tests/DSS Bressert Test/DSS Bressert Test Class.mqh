...
#include <Custom/Confirmation Indicators/DSS Bressert.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_DSSBressert.Pair = pair;
   C1_DSSBressert.Timeframe = timeframe;
   C1_DSSBressert.DSS_EMA_Period = dss_ema_period;
   C1_DSSBressert.DSS_Stoch_Period = dss_stoch_period;
   C1_DSSBressert.DSS_Shift = dss_shift;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_DSSBressert.CheckSignal(1);
}
//+------------------------------------------------------------------+
