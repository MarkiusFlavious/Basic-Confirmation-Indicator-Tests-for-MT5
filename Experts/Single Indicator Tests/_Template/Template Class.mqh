...
//#include <Custom/Confirmation Indicators/Indicator.mqh>
//+------------------------------------------------------------------+
...
// Public Function/Constructor/Destructor Declaration:
                        CSingleIndicatorTester(string pair,
                                               ...
                                               TRADING_METHOD trade_method,
                                               bool move_stop,
                                               bool trail_stop); // <<< Declare Indicator Inputs Here >>>
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
                                               ...
                                               TRADING_METHOD trade_method,
                                               bool move_stop,
                                               bool trail_stop){ // <<< Remember to update this here >>>
   // Initialize Inputs
   Pair = pair;
   Timeframe = timeframe;
