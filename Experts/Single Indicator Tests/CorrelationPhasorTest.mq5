...
input int  inpCorrPhasorPeriod = 35; // Period
//+------------------------------------------------------------------+
//| Handles                                                          |
//+------------------------------------------------------------------+
int ATRChannelHandle;
int CorrPhasorHandle;
//+------------------------------------------------------------------+
//| Global Variables                                                 |
//+------------------------------------------------------------------+
int barTotal;
...
int OnInit()
  {
   ...
   CorrPhasorHandle = iCustom(_Symbol,Timeframe,"Correlation phasor.ex5",inpCorrPhasorPeriod);
...
enTradeSignal CheckForSignal()
  {
   // Zero cross or colour change. Colour change is easier so Buffer value 3. 1 is Orange, 0 is Green.
   double ColourValues[];
   CopyBuffer(CorrPhasorHandle,3,1,2,ColourValues);
