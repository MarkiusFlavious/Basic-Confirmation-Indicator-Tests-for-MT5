...
#include <Custom/Confirmation Indicators/Vortex 2.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_Vortex2.Pair = pair;
   C1_Vortex2.Timeframe = timeframe;
   C1_Vortex2.Vortex_Period = vortex_period;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_Vortex2.CheckSignal(1);
}
//+------------------------------------------------------------------+
