#include "Supertrend Hull Test Class.mqh"
...
input group "Supertrend Hull Inputs:"
input bool input_trail_with_st = false; // Use Supertrend Hull for trail stop
input int input_hull_period = 12; // Hull period
input SUPERTREND_HULL_PRICES input_hull_price = PR_MEDIAN; // Price
input int input_st_atr_period = 12; // ATR period
input double input_st_atr_multiplier = 0.66; // ATR multiplier
//+------------------------------------------------------------------+
//| Globals:                                                         |
//+------------------------------------------------------------------+
