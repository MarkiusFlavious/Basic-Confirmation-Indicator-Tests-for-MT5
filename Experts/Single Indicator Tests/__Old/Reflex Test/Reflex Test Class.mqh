...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   Reflex_Handle = iCustom(Pair,Timeframe,"Reflex.ex5",Reflex_Period);
...
//| - Simple line colour change, buffer = 1                          |
//|   - Blue = 0, red = 1                                            |
//+------------------------------------------------------------------+
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   
   double line_colour[];
   CopyBuffer(Reflex_Handle,1,1,2,line_colour);
