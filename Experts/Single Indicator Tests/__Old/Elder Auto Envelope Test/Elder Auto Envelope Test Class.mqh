...
// Indicator Handles:
   ...
   int Elder_Auto_Envelope_Handle;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   Elder_Auto_Applied_Price = elder_auto_applied_price;
   Deviations_Factor = deviations_factor;
   Deviations_Period = deviations_period;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   Elder_Auto_Envelope_Handle = iCustom(Pair,Timeframe,"elder_auto_envelope_1_2.ex5",Slow_EMA_Period,Fast_EMA_Period,Elder_Auto_Applied_Price,Deviations_Factor,Deviations_Period);
...
//| - Two Line Cross:                                                |
//|   - Fast EMA Buffer = 4, Slow EMA Buffer = 2                     |
//+------------------------------------------------------------------+
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   
   double fast_line[], slow_line[];
   CopyBuffer(Elder_Auto_Envelope_Handle,4,1,2,fast_line);
   CopyBuffer(Elder_Auto_Envelope_Handle,2,1,2,slow_line);
