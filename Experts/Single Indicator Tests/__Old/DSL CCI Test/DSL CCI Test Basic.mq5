...
//| Includes:                                                        |
//+------------------------------------------------------------------+
#include "DSL CCI Test Class.mqh"
//+------------------------------------------------------------------+
//| Inputs:                                                          |
//+------------------------------------------------------------------+
...
input int input_cci_period = 32; // CCI Period
input int input_ma_period = 14; // Average Period (<= 1 for no average)
input ENUM_MA_METHOD input_ma_method = MODE_EMA; // Average Method
input ENUM_APPLIED_PRICE input_ma_applied_price = PRICE_CLOSE; // Average Applie Price
