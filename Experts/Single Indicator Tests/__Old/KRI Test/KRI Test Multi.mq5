...
input group "KRI Inputs:"
input int input_kri_period = 21; // KRI Period
input ENUM_MA_METHOD input_kri_method = MODE_SMA;  // KRI Method
input double input_kri_ratio = 1.0; // KRI Ratio
input KRI_APPLIED_PRICE input_kri_app_price = PRICE_CLOSE_; // KRI Applied Price
//+------------------------------------------------------------------+
//| Globals:                                                         |
//+------------------------------------------------------------------+
