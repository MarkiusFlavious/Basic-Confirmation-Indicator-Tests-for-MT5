...
// Input Parameters:
   ...
   ENUM_APPLIED_PRICE DSL_App_Price;
   DSL_DISPLAY Zones;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   DSL_MACD_Handle = iCustom(Pair,Timeframe,"Dsl MACD.ex5",Fast_EMA,Slow_EMA,Signal_Period,DSL_App_Price,Zones);
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   ...
   double line_colour[];
   CopyBuffer(DSL_MACD_Handle,5,1,2,line_colour);
