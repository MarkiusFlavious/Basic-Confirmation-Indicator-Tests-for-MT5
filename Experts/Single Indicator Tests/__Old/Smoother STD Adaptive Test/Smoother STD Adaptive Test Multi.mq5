...
input bool input_filter_mid_range = false; // Filter mid colour values - Colour range : more orange - 0<-24|25->50 - more green
input int input_start_range = 22; // Filter between
input int input_end_range = 27; // and
//+------------------------------------------------------------------+
//| Globals:                                                         |
//+------------------------------------------------------------------+
