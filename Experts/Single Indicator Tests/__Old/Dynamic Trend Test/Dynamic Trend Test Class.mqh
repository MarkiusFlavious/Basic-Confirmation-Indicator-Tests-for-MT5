...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   DT_Handle = iCustom(Pair,Timeframe,"Downloads\\Dynamic_Trend.ex5",DT_Period,DT_Percent);
...
//| - Price cross or line colour change, I like colour change        |
//|   - Colour Buffer = 1, Blue = 0, Red = 1                         |
//+------------------------------------------------------------------+
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   
   double line_colour[];
   CopyBuffer(DT_Handle,1,1,2,line_colour);
