...
#include <Custom/Confirmation Indicators/Dynamic Trend.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_DynamicTrend.Pair = pair;
   C1_DynamicTrend.Timeframe = timeframe;
   C1_DynamicTrend.DT_Period = dt_period;
   C1_DynamicTrend.DT_Percent = dt_percent;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_DynamicTrend.CheckSignal(1);
}
//+------------------------------------------------------------------+
