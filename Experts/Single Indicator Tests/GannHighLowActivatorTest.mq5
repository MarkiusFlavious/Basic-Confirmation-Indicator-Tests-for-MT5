...
input group "Gann High Low Activator Input"
input int  inpPeriod = 14;  // Activator period
//+------------------------------------------------------------------+
//| Handles                                                          |
//+------------------------------------------------------------------+
int ATRChannelHandle;
int GannHighLowActivatorHandle;
//+------------------------------------------------------------------+
//| Global Variables                                                 |
//+------------------------------------------------------------------+
int barTotal;
...
int OnInit()
  {
   ...
   GannHighLowActivatorHandle = iCustom(_Symbol,Timeframe,"Gann high low activator (oscillator).ex5",inpPeriod);
...
enTradeSignal CheckForSignal()
  {
   // Colour 1. 1 Red, 0 Green
   double ColourValues[];
   CopyBuffer(GannHighLowActivatorHandle,1,1,2,ColourValues);
