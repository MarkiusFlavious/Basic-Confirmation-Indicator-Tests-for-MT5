...
#include <Custom/Confirmation Indicators/PTLv2.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_PTLv2.Pair = pair;
   C1_PTLv2.Timeframe = timeframe;
   C1_PTLv2.PTL_Fast_Length = ptl_fast_length;
   C1_PTLv2.PTL_Slow_Length = ptl_slow_length;
