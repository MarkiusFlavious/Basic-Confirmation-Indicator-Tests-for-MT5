...
#include <Custom/Confirmation Indicators/QQE.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_QQE.Pair = pair;
   C1_QQE.Timeframe = timeframe;
   C1_QQE.QQE_RSI_Period = qqe_rsi_period;
   C1_QQE.QQE_RSI_Smoothing_Factor = qqe_rsi_smoothing_factor;
   C1_QQE.QQE_WP_Fast = qqe_wp_fast;
   C1_QQE.QQE_WP_Slow = qqe_wp_slow;
   C1_QQE.QQE_Applied_Price = qqe_applied_price;
