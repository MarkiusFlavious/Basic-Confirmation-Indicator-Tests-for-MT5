...
#include <Custom/Confirmation Indicators/Elegant Oscillator.mqh>
//+------------------------------------------------------------------+
...
// Input Parameters:
   ...
   // Indicator:
   ElegantOscillator C1_ElegantOscillator;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_ElegantOscillator.Pair = pair;
   C1_ElegantOscillator.Timeframe = timeframe;
   C1_ElegantOscillator.Band_Edge = band_edge;
   C1_ElegantOscillator.Oscillator_Period = oscillator_period;
   C1_ElegantOscillator.Oscillator_Applied_Price = oscillator_applied_price;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_ElegantOscillator.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_ElegantOscillator.CheckSignal(1);
}
//+------------------------------------------------------------------+
