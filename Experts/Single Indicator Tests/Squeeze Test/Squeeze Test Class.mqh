...
#include <Custom/Confirmation Indicators/Squeeze.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_Squeeze.Pair = pair;
   C1_Squeeze.Timeframe = timeframe;
   C1_Squeeze.Squeeze_Period = squeeze_period;
   C1_Squeeze.Dev_Multiplier = dev_multiplier;
   C1_Squeeze.Atr_Multiplier = atr_multiplier;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_Squeeze.CheckSignal(1);
}
//+------------------------------------------------------------------+
