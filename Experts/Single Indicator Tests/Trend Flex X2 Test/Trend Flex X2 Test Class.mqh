...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_TrendFlexX2.Pair = pair;
   C1_TrendFlexX2.Timeframe = timeframe;
   C1_TrendFlexX2.Fast_Period = fast_period;
   C1_TrendFlexX2.Slow_Period = slow_period;
   C1_TrendFlexX2.Method = method;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_TrendFlexX2.CheckSignal(1);
}
//+------------------------------------------------------------------+
