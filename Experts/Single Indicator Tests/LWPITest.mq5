...
input uint inpLWPIPeriod = 8; // LWPI Period
//+------------------------------------------------------------------+
//| Handles                                                          |
//+------------------------------------------------------------------+
...
int OnInit()
  {
   ...
   LWPIHandle = iCustom(_Symbol,Timeframe,"LWPI.ex5", inpLWPIPeriod);
...
enTradeSignal CheckForSignal()
  {
   ...
   double LWPIValues[];
   CopyBuffer(LWPIHandle,0,1,2,LWPIValues);
   ArrayReverse(LWPIValues);
   
   if ((LWPIValues[0] < 50.0) && (LWPIValues[1] > 50.0))
   {
    return buy_signal;
   }
   if((LWPIValues[0] > 50.0) && (LWPIValues[1] < 50.0))
