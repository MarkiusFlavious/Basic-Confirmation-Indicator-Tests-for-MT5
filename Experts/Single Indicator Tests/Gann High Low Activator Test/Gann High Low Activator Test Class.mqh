...
#include <Custom/Confirmation Indicators/Gann High Low.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_GannHighLow.Pair = pair;
   C1_GannHighLow.Timeframe = timeframe;
   C1_GannHighLow.Activator_Period = activator_period;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_GannHighLow.CheckSignal(1);
}
//+------------------------------------------------------------------+
