...
#include <Custom/Confirmation Indicators/Half Trend.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_HalfTrend.Pair = pair;
   C1_HalfTrend.Timeframe = timeframe;
   C1_HalfTrend.Half_Trend_Amp = half_trend_amp;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_HalfTrend.CheckSignal(1);
}
//+------------------------------------------------------------------+
