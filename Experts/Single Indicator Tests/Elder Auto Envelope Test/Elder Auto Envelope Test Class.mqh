...
#include <Custom/Confirmation Indicators/Elder Auto Envelope.mqh>
//+------------------------------------------------------------------+
...
// Input Parameters:
   ...
   // Indicator:
   ElderAutoEnvelope C1_ElderAutoEnvelope;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_ElderAutoEnvelope.Pair = pair;
   C1_ElderAutoEnvelope.Timeframe = timeframe;
   C1_ElderAutoEnvelope.Slow_EMA_Period = slow_ema_period;
   C1_ElderAutoEnvelope.Fast_EMA_Period = fast_ema_period;
   C1_ElderAutoEnvelope.Elder_Auto_Applied_Price = elder_auto_applied_price;
   C1_ElderAutoEnvelope.Deviations_Factor = deviations_factor;
   C1_ElderAutoEnvelope.Deviations_Period = deviations_period;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_ElderAutoEnvelope.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_ElderAutoEnvelope.CheckSignal(1);
}
//+------------------------------------------------------------------+
