...
#include <Custom/Confirmation Indicators/DiNapoli Stochastic.mqh>
//+------------------------------------------------------------------+
...
// Input Parameters:
   ...
   // Indicator:
   DiNapoliStochastic C1_DiNapoliStochastic;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_DiNapoliStochastic.Pair = pair;
   C1_DiNapoliStochastic.Timeframe = timeframe;
   C1_DiNapoliStochastic.FastK_Period = fastK_period;
   C1_DiNapoliStochastic.SlowK_Period = slowK_period;
   C1_DiNapoliStochastic.SlowD_Period = slowD_period;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_DiNapoliStochastic.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_DiNapoliStochastic.CheckSignal(1);
}
//+------------------------------------------------------------------+
