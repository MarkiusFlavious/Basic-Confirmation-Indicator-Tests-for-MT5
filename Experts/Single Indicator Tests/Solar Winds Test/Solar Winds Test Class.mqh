...
#include <Custom/Confirmation Indicators/Solar Winds.mqh>
//+------------------------------------------------------------------+
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_SolarWinds.Pair = pair;
   C1_SolarWinds.Timeframe = timeframe;
   C1_SolarWinds.SW_Period = sw_period;
   C1_SolarWinds.SW_Smooth = sw_smooth;
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_SolarWinds.CheckSignal(1);
}
//+------------------------------------------------------------------+
