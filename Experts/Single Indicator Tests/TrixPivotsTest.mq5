...
input group "Trix (Pivots) Inputs"
...
int OnInit()
  {
   ...
   TrixHandle = iCustom(_Symbol,Timeframe,"Trix (pivots).ex5",inpTimeFrame,inpPeriod,inpPrice,inpColorSup,inpColorRes,inpColorPiv,inpDisplayType);
...
enTradeSignal CheckForSignal()
  {
   // Colour Change Buffer 8. 1 is green and 2 is red.
   double ColourValues[];
   CopyBuffer(TrixHandle,8,1,2,ColourValues);
