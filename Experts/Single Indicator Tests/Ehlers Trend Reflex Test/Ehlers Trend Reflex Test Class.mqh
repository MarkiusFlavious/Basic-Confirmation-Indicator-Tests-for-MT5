...
#include <Custom/Confirmation Indicators/Ehlers Trend Reflex.mqh>
//+------------------------------------------------------------------+
...
// Input Parameters:
   ...
   // Indicator:
   EhlersTrendReflex C1_EhlersTrendReflex;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   C1_EhlersTrendReflex.Pair = pair;
   C1_EhlersTrendReflex.Timeframe = timeframe;
   C1_EhlersTrendReflex.TReflex_Length = treflex_length;
   C1_EhlersTrendReflex.Method = method;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   C1_EhlersTrendReflex.Initialize();
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   return C1_EhlersTrendReflex.CheckSignal(1);
}
//+------------------------------------------------------------------+
