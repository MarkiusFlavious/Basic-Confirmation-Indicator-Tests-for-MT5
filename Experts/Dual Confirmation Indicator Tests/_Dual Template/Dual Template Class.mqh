...
//#include <Custom/Confirmation Indicators/Indicator1.mqh>
//#include <Custom/Confirmation Indicators/Indicator2.mqh>
//+------------------------------------------------------------------+
...
// Indicators:
   //<<< Declare Indicator Objects Here >>>
...
// Public Function/Constructor/Destructor Declaration:
                        CDualIndicatorTest(string pair,
                                             ...
                                             bool move_stop,
                                             bool trail_stop,
                                             DOMINANCE_MODE indicator_dominance_mode); // <<< Declare Indicator Inputs Here >>>
...
CDualIndicatorTest::CDualIndicatorTest(string pair,
                                           ...
                                           bool move_stop,
                                           bool trail_stop,
                                           DOMINANCE_MODE indicator_dominance_mode){ // <<< Remember to update this here >>>
   // Initialize Inputs
   Pair = pair;
   Timeframe = timeframe;
...
int CDualIndicatorTest::OnInitEvent(void){
   ...
   // <<< Call Indicator Initialization Functions>>>
...
TRADING_TERMS CDualIndicatorTest::CheckExit(void){
   /*
   if (C1_Indicator.Is_Exit_Indicator && !C2_Indicator.Is_Exit_Indicator){
      return C1_Indicator.CheckSignal(1);
   }
   else if (C2_Indicator.Is_Exit_Indicator && !C1_Indicator.Is_Exit_Indicator){
      return C2_Indicator.CheckSignal(1);
   }
   else {
      TRADING_TERMS c1_signal = C1_Indicator.CheckSignal(1);
      TRADING_TERMS c2_signal = C2_Indicator.CheckSignal(1);
