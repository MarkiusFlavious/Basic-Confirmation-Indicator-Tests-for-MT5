...
int OnInit(){
   ...
   Dslu_Rsi_Avg_Handle = iCustom(_Symbol,input_timeframe,"Dslu RSI of average.ex5",input_rsi_period,input_ma_period,input_ma_method,input_app_price,input_signal_period,input_zones);
...
TRADING_TERMS LookForSignal(){
   ...
   double line_colour[];
   CopyBuffer(Dslu_Rsi_Avg_Handle,5,1,2,line_colour);
