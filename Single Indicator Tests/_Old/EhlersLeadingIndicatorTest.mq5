...
input group "Ehlers Leading Indicator Inputs"
...
int OnInit()
  {
   ...
   EhlersLeadingIndiHandle = iCustom(_Symbol,Timeframe,"EhlersLeadingIndicator.ex5",alpha1,alpha2);
...
enTradeSignal CheckForSignal()
  {
   //Colour Buffer 1. 1 is Red and 2 is Green.
   double ColourValues[];
   CopyBuffer(EhlersLeadingIndiHandle,1,1,2,ColourValues);
