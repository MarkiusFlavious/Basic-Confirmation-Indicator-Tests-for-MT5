...
int OnInit()
  {
   ...
   KalmanFilterHandle = iCustom(_Symbol,Timeframe,"Kalman filter (mtf).ex5",inpTimeFrame,inpPeriod,inpPrice,inpInterpolate);
...
enTradeSignal CheckForSignal()
  {
   // Signal on Colour Change. Buffer Value 1. 1 is Bullish and 2 is Bearish.
   double ColourValues[];
   CopyBuffer(KalmanFilterHandle,1,1,2,ColourValues);
