...
input group "Vortex Input"
input int inpVortexLength = 14; // Vortex Length
//+------------------------------------------------------------------+
//| Handles                                                          |
//+------------------------------------------------------------------+
...
int OnInit()
  {
   ...
   VortexHandle = iCustom(_Symbol,Timeframe,"Vortex.ex5",inpVortexLength);
...
enTradeSignal CheckForSignal()
  {
   double VortexPlusValues[];
   CopyBuffer(VortexHandle,0,1,2,VortexPlusValues);
   ArrayReverse(VortexPlusValues);
   
   double VortexMinusValues[];
   CopyBuffer(VortexHandle,1,1,2,VortexMinusValues);
   ArrayReverse(VortexMinusValues);
   
   if ((VortexPlusValues[0] > VortexMinusValues[0]) && (VortexPlusValues[1] < VortexMinusValues[1]))
   {
    return buy_signal;
   }
   if ((VortexPlusValues[0] < VortexMinusValues[0]) && (VortexPlusValues[1] > VortexMinusValues[1]))
