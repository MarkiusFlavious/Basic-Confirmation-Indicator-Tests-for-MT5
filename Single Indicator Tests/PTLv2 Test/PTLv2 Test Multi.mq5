...
input int input_ptl_fast_length = 3; // Fast length
input int input_ptl_slow_length = 7; // Slow length
//+------------------------------------------------------------------+
//| Globals:                                                         |
//+------------------------------------------------------------------+
...
int OnInit(){
   ...
   for (int pos = 0; pos < ArraySize(pair_array); pos++){
      strategy_array.Add(new CSingleIndicatorTester(pair_array[pos],
                                                    ...
                                                    input_move_stop,
                                                    input_trail_stop,
                                                    input_ptl_fast_length,
                                                    input_ptl_slow_length));
   }
