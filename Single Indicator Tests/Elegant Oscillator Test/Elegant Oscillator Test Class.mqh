...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   Oscillator_Applied_Price = oscillator_applied_price;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   Elegant_Oscillator_handle = iCustom(Pair,Timeframe,"Elegant oscillator.ex5",Band_Edge,Oscillator_Period,Oscillator_Applied_Price);
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   ...
   double line_value[];
   CopyBuffer(Elegant_Oscillator_handle,0,1,2,line_value);
