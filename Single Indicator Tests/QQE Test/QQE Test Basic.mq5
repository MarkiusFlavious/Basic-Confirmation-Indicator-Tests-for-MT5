...
input group "QQE Inputs:"
input int input_qqe_rsi_period = 8; // QQE RSI period
input int input_qqe_rsi_smoothing_factor = 1; // QQE RSI smoothing factor
input double input_qqe_wp_fast = 3; // QQE Fast period
input double input_qqe_wp_slow = 4.236; // QQE Slow period
input ENUM_APPLIED_PRICE input_qqe_applied_price = PRICE_CLOSE; // QQE Applied Price 
//+------------------------------------------------------------------+
//|Global:                                                           |
//+------------------------------------------------------------------+
CSingleIndicatorTester Simple_Strategy(_Symbol,
                                       ...
                                       input_move_stop,
                                       input_trail_stop,
                                       input_qqe_rsi_period,
                                       input_qqe_rsi_smoothing_factor,
                                       input_qqe_wp_fast,
                                       input_qqe_wp_slow,
                                       input_qqe_applied_price);
//+------------------------------------------------------------------+
