...
// Input Parameters:
   ...
   // Ehlers Decycler Oscillator Inputs:
   int Decycler_Period1;
   int Decycler_Period2;

// Indicator Handles:
   int ATR_Channel_Handle;
   int Ehlers_Decycler_Osc_Handle;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   Decycler_Period1 = decycler_period1;
   Decycler_Period2 = decycler_period2;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   Ehlers_Decycler_Osc_Handle = iCustom(Pair,Timeframe,"EhlersDecyclerOscillator.ex5",Decycler_Period1,Decycler_Period2);
...
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   ...
   double line_value[];
   CopyBuffer(Ehlers_Decycler_Osc_Handle,0,1,2,line_value);
