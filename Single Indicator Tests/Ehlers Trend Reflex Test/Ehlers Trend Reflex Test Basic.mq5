...
//| Includes:                                                        |
//+------------------------------------------------------------------+
#include "Ehlers Trend Reflex Test Class.mqh"
//+------------------------------------------------------------------+
//| Inputs:                                                          |
//+------------------------------------------------------------------+
...
input group "Ehlers Trend Reflex Inputs:"
input int input_treflex_length = 20; // Trend Reflex Length
input TREND_REFLEX_METHOD input_method = TWO_LINES_CROSS; // Method
//+------------------------------------------------------------------+
//|Global:                                                           |
//+------------------------------------------------------------------+
