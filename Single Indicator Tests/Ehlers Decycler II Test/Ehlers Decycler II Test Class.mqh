...
// Input Parameters:
   ...
   // Ehlers Decycler II Inputs:
   int Decycler_Period;
   double Channel_Width;

// Indicator Handles:
   int ATR_Channel_Handle;
   int Ehlers_Decycler_II_Handle;
...
CSingleIndicatorTester::CSingleIndicatorTester(string pair,
   ...
   Decycler_Period = decycler_period;
...
int CSingleIndicatorTester::OnInitEvent(void){
   ...
   Ehlers_Decycler_II_Handle = iCustom(Pair,Timeframe,"EhlersDecycler-II.ex5",Decycler_Period,Channel_Width);
...
//| - Simple Line Colour Change:                                     |
//|   - Buffer = 1, Blue = 1, Red = 2                                |
//+------------------------------------------------------------------+
TRADING_TERMS CSingleIndicatorTester::LookForSignal(void){
   
   double line_colour[];
   CopyBuffer(Ehlers_Decycler_II_Handle,1,1,2,line_colour);
