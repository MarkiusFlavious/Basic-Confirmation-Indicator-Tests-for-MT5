...
//| Includes:                                                        |
//+------------------------------------------------------------------+
#include "Step Stochastic Test Class.mqh"
//+------------------------------------------------------------------+
//| Inputs:                                                          |
//+------------------------------------------------------------------+
...
input ENUM_APPLIED_PRICE input_step_stoch_price = PRICE_MEDIAN; // Applied Price
input int input_step_atr_period = 10; // ATR Period
input double input_k_slow = 1.0; // K slow 
input double input_k_fast = 1.0; // K fast
//+------------------------------------------------------------------+
//|Global:                                                           |
//+------------------------------------------------------------------+
CSingleIndicatorTester Simple_Strategy(_Symbol,
                                       ...
                                       input_move_stop,
                                       input_trail_stop,
                                       input_step_stoch_price,
                                       input_step_atr_period,
                                       input_k_slow,
                                       input_k_fast);
//+------------------------------------------------------------------+
